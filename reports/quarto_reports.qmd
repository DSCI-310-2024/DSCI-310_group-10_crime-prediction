...
![Coefficents of Logistic Regression Model](../reports/coefficients_of_logistic_regression.png){#coefficents__logistic_plot width=70%}

The @coefficents__logistic_plot illustrates the coefficients of the features in the Logistic Regression model.
...
Days of the Week: From the @coefficents__logistic_plot, Tuesday and Wednesday show positive coefficients, suggesting a slight increase in the likelihood of incidents on these days. Conversely, Sunday exhibits a significantly negative coefficient, indicating a lower likelihood of incidents.
