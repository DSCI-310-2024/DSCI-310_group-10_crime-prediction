...
![The Distribution of Time Period.](../results/time_period_plot.png){#time-period-plot width=70%}
...
![Incidents Records by Day & Time Period](../results/records_by_time_and_day_plot.png){#time-day width=70%}
...
![Coefficents of Logistic Regression Model](../results/coefficients_of_lr_model_plot.png){#coefficents-lr-plot width=70%}
