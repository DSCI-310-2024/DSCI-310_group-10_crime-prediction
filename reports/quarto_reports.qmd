...
The @fig-time-period-plot depicts the distribution of incidents across different time periods, revealing a notable concentration of records in the afternoon. This observation suggests that a significant portion of incidents tend to occur during the afternoon hours.
...
new_dummy_score = pd.DataFrame({
    'Dummy Classifier': ['Dummy Score'],
    'Score': [dummy_score['Score'][0]]
})

markdown_table = new_dummy_score.to_markdown(index=False)

Markdown(markdown_table)

#md = tabulate(dummy_score, headers='keys', tablefmt='pipe',showindex=False)

#Markdown(dummy_score.to_markdown())

# Markdown("""
# Dummy Classifier Score:{dummy_score}
# """.format
#     (dummy_score=dummy_score['Dummy Score'][1]
# ))
```
...
""".format(
    fit_time=cross_validation_results['fit_time'][0],  
    score_time=cross_validation_results['score_time'][0],  
    test_score=cross_validation_results['test_score'][0],  
    train_score=cross_validation_results['train_score'][0]  )
...
The @fig-coefficents-lr-plot illustrates the coefficients of the features in the Logistic Regression model.
